...
props.store.categorie.forEach(category => {
    category.services = category.services.filter(item => item.id !== props.service.id);
    categoriesServices.value.push(category);
});
const servicesNullCategory = ref(props.services);
    ...
    <div class="bg-gray-100">
        <div class=" max-w-screen-lg py-10 mx-auto min-h-screen ">
            ...
            <div class="my-12">
                ...
                <div v-for="service in selectedService" class="my-2 mt-4 bg-white rounded border">
            ...
            <div v-if="!isAuth" class="bg-white p-10 mt-5 rounded-lg drop-shadow-sm">
                <h1 class="text-xl font-medium text-center">Not yet registered?</h1>
                <button class="p-3 border border-black hover:bg-black hover:text-white text-sm duration-300 w-full my-4 rounded-lg"> Create Accounte</button>
                ...
                <button class="p-3 border bg-black w-full  opacity-90 hover:opacity-100 text-sm text-white my-4 rounded-lg">Login</button>
            </div>
            <div v-if="isAuth" class="my-10">
